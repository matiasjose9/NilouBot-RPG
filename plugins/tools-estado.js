...
var handler = async (m, { conn, command, usedPrefix }) => {
  try {
    ...
    let cpuModel = await cpu.model();  // Awaited the model method
    let cpuPer;
...
*Internet OUT* : ${netsOut}`;
    ...
    await conn.relayMessage(m.chat, { extendedTextMessage: { text: txt, contextInfo: { externalAdReply: { title: '', mediaType: 1, previewType: 0, renderLargerThumbnail: true, thumbnailUrl: 'https://telegra.ph/file/56d6e15d7ebf5fc5d0d26.jpg', sourceUrl: '' } }, mentions: [m.sender] } }, {});
